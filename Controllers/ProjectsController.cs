...
namespace CompanyPortfolioo.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Bio,MainImagePath,ProjectCategoryId")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Bio,MainImagePath,ProjectCategoryId")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
