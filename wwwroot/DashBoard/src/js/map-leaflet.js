$(document).ready(function () {
  ...
  var customIconBlue = L.icon({
    iconUrl: '~/DashBoard/app-assets/img/map/leaflet/map-marker-blue.png',
    iconSize: [52, 52], // size of the icon
    iconAnchor: [22, 94], // point of the icon which will correspond to marker's location
    popupAnchor: [-3, -76] // point from which the popup should open relative to the iconAnchor
  });
  var customIconRed = L.icon({
    iconUrl: '~/DashBoard/app-assets/img/map/leaflet/leaf-red.png',
    iconSize: [38, 95], // size of the icon
    shadowUrl: '~/DashBoard/app-assets/img/map/leaflet/leaf-shadow.png',
